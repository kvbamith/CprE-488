...
#
# MP_0_tutorial.tcl: Tcl script for re-creating project 'MP_0_tutorial'
#
# Generated by Vivado on Tue Feb 04 21:21:05 -0600 2020
...
#
# 1. This project restoration tcl script (MP_0_tutorial.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "U:/cpre488/Labs/MP-0/MP_0_tutorial/MP_0_tutorial.srcs/sources_1/bd/zynq_design_1/hdl/zynq_design_1_wrapper.vhd"
#
# 3. The following remote source files that were added to the original project:-
#
#    "U:/cpre488/Labs/MP-0/docs/ZedBoard/zedboard_master.xdc"
#
#*****************************************************************************************
...
set _xil_proj_name_ "MP_0_tutorial"
...
set script_file "MP_0_tutorial.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../../MP_0_tutorial"]"
...
set files [list \
 [file normalize "${origin_dir}/../../MP_0_tutorial/MP_0_tutorial.srcs/sources_1/bd/zynq_design_1/hdl/zynq_design_1_wrapper.vhd" ]\
]
...
proc cr_bd_zynq_design_1 { parentCell } {
  ...
  set proc_clk [ create_bd_port -dir O -from 0 -to 0 proc_clk ]
  ...
  set vid_active [ create_bd_port -dir O vid_active ]
  set vid_b [ create_bd_port -dir O -from 3 -to 0 vid_b ]
  set vid_g [ create_bd_port -dir O -from 3 -to 0 vid_g ]
  set vid_hblank [ create_bd_port -dir O vid_hblank ]
  set vid_hsync [ create_bd_port -dir O vid_hsync ]
  set vid_overflow [ create_bd_port -dir O -from 0 -to 0 vid_overflow ]
  set vid_r [ create_bd_port -dir O -from 3 -to 0 vid_r ]
  set vid_underflow [ create_bd_port -dir O -from 0 -to 0 vid_underflow ]
  set vid_vblank [ create_bd_port -dir O vid_vblank ]
  set vid_vsync [ create_bd_port -dir O vid_vsync ]
  set vtc_activeout [ create_bd_port -dir O -from 0 -to 0 vtc_activeout ]
  set vtc_clk [ create_bd_port -dir O -from 0 -to 0 vtc_clk ]
  set vtc_hblank [ create_bd_port -dir O -from 0 -to 0 vtc_hblank ]
  set vtc_hsync [ create_bd_port -dir O -from 0 -to 0 vtc_hsync ]
  set vtc_vblank [ create_bd_port -dir O -from 0 -to 0 vtc_vblank ]
  set vtc_vsync [ create_bd_port -dir O -from 0 -to 0 vtc_vsync ]
  ...
  connect_bd_net -net axi_vdma_0_m_axis_mm2s_tdata [get_bd_pins axi_gpio_4/gpio_io_i] [get_bd_pins axi_vdma_0/m_axis_mm2s_tdata] [get_bd_pins v_axi4s_vid_out_0/s_axis_video_tdata]
  connect_bd_net -net axi_vdma_0_m_axis_mm2s_tlast [get_bd_ports tLast] [get_bd_pins axi_vdma_0/m_axis_mm2s_tlast] [get_bd_pins v_axi4s_vid_out_0/s_axis_video_tlast]
  connect_bd_net -net axi_vdma_0_m_axis_mm2s_tuser [get_bd_ports tUser] [get_bd_pins axi_vdma_0/m_axis_mm2s_tuser] [get_bd_pins v_axi4s_vid_out_0/s_axis_video_tuser]
  connect_bd_net -net axi_vdma_0_m_axis_mm2s_tvalid [get_bd_ports tValid] [get_bd_pins axi_vdma_0/m_axis_mm2s_tvalid] [get_bd_pins v_axi4s_vid_out_0/s_axis_video_tvalid]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_ports vtc_clk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_clk] [get_bd_pins v_tc_0/clk]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_ports proc_clk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_gpio_2/s_axi_aclk] [get_bd_pins axi_gpio_3/s_axi_aclk] [get_bd_pins axi_gpio_4/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/M05_ACLK] [get_bd_pins ps7_0_axi_periph/M06_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins v_axi4s_vid_out_0/aclk] [get_bd_pins v_tc_0/s_axi_aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_gpio_2/s_axi_aresetn] [get_bd_pins axi_gpio_3/s_axi_aresetn] [get_bd_pins axi_gpio_4/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/M06_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins v_axi4s_vid_out_0/aresetn] [get_bd_pins v_tc_0/s_axi_aresetn]
  ...
  connect_bd_net -net v_axi4s_vid_out_0_overflow [get_bd_ports vid_overflow] [get_bd_pins v_axi4s_vid_out_0/overflow]
  connect_bd_net -net v_axi4s_vid_out_0_s_axis_video_tready [get_bd_ports tReady] [get_bd_pins axi_vdma_0/m_axis_mm2s_tready] [get_bd_pins v_axi4s_vid_out_0/s_axis_video_tready]
  connect_bd_net -net v_axi4s_vid_out_0_status [get_bd_pins axi_gpio_3/gpio_io_i] [get_bd_pins v_axi4s_vid_out_0/status]
  connect_bd_net -net v_axi4s_vid_out_0_underflow [get_bd_ports vid_underflow] [get_bd_pins v_axi4s_vid_out_0/underflow]
  connect_bd_net -net v_axi4s_vid_out_0_vid_active_video [get_bd_ports vid_active] [get_bd_pins v_axi4s_vid_out_0/vid_active_video]
  ...
  connect_bd_net -net v_tc_0_active_video_out [get_bd_ports vtc_activeout] [get_bd_pins v_axi4s_vid_out_0/vtg_active_video] [get_bd_pins v_tc_0/active_video_out]
  connect_bd_net -net v_tc_0_hblank_out [get_bd_ports vtc_hblank] [get_bd_pins v_axi4s_vid_out_0/vtg_hblank] [get_bd_pins v_tc_0/hblank_out]
  connect_bd_net -net v_tc_0_hsync_out [get_bd_ports vtc_hsync] [get_bd_pins v_axi4s_vid_out_0/vtg_hsync] [get_bd_pins v_tc_0/hsync_out]
  connect_bd_net -net v_tc_0_vblank_out [get_bd_ports vtc_vblank] [get_bd_pins v_axi4s_vid_out_0/vtg_vblank] [get_bd_pins v_tc_0/vblank_out]
  connect_bd_net -net v_tc_0_vsync_out [get_bd_ports vtc_vsync] [get_bd_pins v_axi4s_vid_out_0/vtg_vsync] [get_bd_pins v_tc_0/vsync_out]
  connect_bd_net -net xlslice_0_Dout [get_bd_ports vid_b] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_ports vid_g] [get_bd_pins xlslice_1/Dout]
  connect_bd_net -net xlslice_2_Dout [get_bd_ports vid_r] [get_bd_pins xlslice_2/Dout]
