...
# JA Pmod - Bank 13 
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y11  [get_ports {vid_active}];  # "JA1"
set_property PACKAGE_PIN AA8  [get_ports {vid_hblank}];  # "JA10"
#set_property PACKAGE_PIN AA11 [get_ports {}];  # "JA2"
set_property PACKAGE_PIN Y10  [get_ports {vid_vblank}];  # "JA3"
...
# JB Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN W12 [get_ports {vtc_activeout}];  # "JB1"
set_property PACKAGE_PIN W11 [get_ports {vtc_hblank}];  # "JB2"
set_property PACKAGE_PIN V10 [get_ports {vtc_hsync}];  # "JB3"
set_property PACKAGE_PIN W8 [get_ports {vtc_vblank}];  # "JB4"
set_property PACKAGE_PIN V12 [get_ports {vtc_vsync}];  # "JB7"
set_property PACKAGE_PIN W10 [get_ports {vtc_clk}];  # "JB8"
...
# JC Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN AB6 [get_ports {locked}];  # "JC1_N"
set_property PACKAGE_PIN AB7 [get_ports {tLast}];  # "JC1_P"
set_property PACKAGE_PIN AA4 [get_ports {tValid}];  # "JC2_N"
set_property PACKAGE_PIN Y4  [get_ports {tUser}];  # "JC2_P"
set_property PACKAGE_PIN T6  [get_ports {vid_overflow}];  # "JC3_N"
set_property PACKAGE_PIN R6  [get_ports {vid_underflow}];  # "JC3_P"
...
# JD Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN W7 [get_ports {proc_clk}];  # "JD1_N"
set_property PACKAGE_PIN V7 [get_ports {tReady}];  # "JD1_P"
...
# VGA Output - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y21  [get_ports {vid_b[0]}];  # "VGA-B1"
set_property PACKAGE_PIN Y20  [get_ports {vid_b[1]}];  # "VGA-B2"
set_property PACKAGE_PIN AB20 [get_ports {vid_b[2]}];  # "VGA-B3"
set_property PACKAGE_PIN AB19 [get_ports {vid_b[3]}];  # "VGA-B4"
set_property PACKAGE_PIN AB22 [get_ports {vid_g[0]}];  # "VGA-G1"
set_property PACKAGE_PIN AA22 [get_ports {vid_g[1]}];  # "VGA-G2"
set_property PACKAGE_PIN AB21 [get_ports {vid_g[2]}];  # "VGA-G3"
set_property PACKAGE_PIN AA21 [get_ports {vid_g[3]}];  # "VGA-G4"
set_property PACKAGE_PIN AA19 [get_ports {vid_hsync}];  # "VGA-HS"
set_property PACKAGE_PIN V20  [get_ports {vid_r[0]}];  # "VGA-R1"
set_property PACKAGE_PIN U20  [get_ports {vid_r[1]}];  # "VGA-R2"
set_property PACKAGE_PIN V19  [get_ports {vid_r[2]}];  # "VGA-R3"
set_property PACKAGE_PIN V18  [get_ports {vid_r[3]}];  # "VGA-R4"
