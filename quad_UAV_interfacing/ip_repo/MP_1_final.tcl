...
#
# MP_1_final.tcl: Tcl script for re-creating project 'MP_1_final'
#
# Generated by Vivado on Tue Feb 18 21:44:11 -0600 2020
...
#
# 1. This project restoration tcl script (MP_1_final.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "U:/cpre488/Labs/MP-1/MP_1_final/MP_1_final.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.vhd"
#    "U:/cpre488/Labs/MP-1/MP_1_final/design_1_wrapper_behav.wcfg"
#
# 3. The following remote source files that were added to the original project:-
#
#    "U:/cpre488/Labs/MP-1/docs/ZedBoard/zedboard_master.xdc"
#
#*****************************************************************************************
...
set _xil_proj_name_ "MP_1_final"
...
set script_file "MP_1_final.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../MP_1_final"]"
...
set files [list \
 [file normalize "${origin_dir}/../MP_1_final/MP_1_final.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.vhd" ]\
]
...
set file "[file normalize "$origin_dir/../docs/ZedBoard/zedboard_master.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../docs/ZedBoard/zedboard_master.xdc"
...
# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/../MP_1_final/design_1_wrapper_behav.wcfg" ]\
]
...
proc cr_bd_design_1 { parentCell } {
  ...
  # Create ports
  set FSM_reset [ create_bd_port -dir I -from 0 -to 0 FSM_reset ]
  set PPM_input [ create_bd_port -dir I -from 0 -to 0 PPM_input ]
  set PPM_output [ create_bd_port -dir O -from 0 -to 0 PPM_output ]
  ...
  connect_bd_net -net FSM_reset_1 [get_bd_ports FSM_reset] [get_bd_pins axi_gpio_0/gpio2_io_i]
  connect_bd_net -net PPM_input_1 [get_bd_ports PPM_input] [get_bd_pins axi_ppm_0/PPM_input]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins axi_ppm_0/FSM_reset]
  connect_bd_net -net axi_ppm_0_PPM_output [get_bd_ports PPM_output] [get_bd_pins axi_ppm_0/PPM_output]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_gpio_2/s_axi_aresetn] [get_bd_pins axi_ppm_0/s00_axi_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_ppm_0/S00_AXI/S00_AXI_reg] SEG_axi_ppm_0_S00_AXI_reg
...
preplace port sws_8bits -pg 1 -y 860 -defaultsOSRD
preplace port btns_5bits -pg 1 -y 1010 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 80 -defaultsOSRD
preplace portBus PPM_output -pg 1 -y 650 -defaultsOSRD
preplace portBus PPM_input -pg 1 -y 650 -defaultsOSRD
preplace portBus FSM_reset -pg 1 -y 740 -defaultsOSRD
preplace inst axi_ppm_0 -pg 1 -lvl 3 -y 610 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 1 -y 600 -defaultsOSRD
preplace inst proc_sys_reset_0 -pg 1 -lvl 1 -y 390 -defaultsOSRD
preplace inst axi_gpio_1 -pg 1 -lvl 1 -y 870 -defaultsOSRD
preplace inst axi_gpio_2 -pg 1 -lvl 1 -y 1020 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 2 -y 610 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -y 140 -defaultsOSRD
preplace netloc ps7_0_axi_periph_M02_AXI 1 0 3 10J 780 740J 790 1070
preplace netloc processing_system7_0_DDR 1 1 3 NJ 60 NJ 60 NJ
preplace netloc processing_system7_0_M_AXI_GP0 1 1 1 730
preplace netloc PPM_input_1 1 0 3 -20J 280 NJ 280 1120
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 0 0 710
preplace netloc ps7_0_axi_periph_M03_AXI 1 0 3 20 790 730J 800 1060
preplace netloc FSM_reset_1 1 0 2 NJ 740 710
preplace netloc ps7_0_axi_periph_M01_AXI 1 0 3 20J 290 NJ 290 1070
preplace netloc axi_gpio_0_gpio_io_o 1 1 2 710 420 1110J
preplace netloc axi_ppm_0_PPM_output 1 3 1 1380
preplace netloc processing_system7_0_FIXED_IO 1 1 3 NJ 80 NJ 80 NJ
preplace netloc proc_sys_reset_0_peripheral_aresetn 1 0 3 0 510 720 430 1080
preplace netloc axi_gpio_2_GPIO 1 1 3 NJ 1020 NJ 1020 1380J
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 -10 -10 740 410 1090
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 1100
preplace netloc axi_gpio_1_GPIO 1 1 3 720J 860 NJ 860 NJ
levelinfo -pg 1 -40 500 910 1250 1400 -top -170 -bot 1520
"
}
